...
Deterministic tool-call Firewall gates use injected typed policy, exact target revisions, and fail-closed compact decisions; see [`docs/spec/FIREWALL.md`](docs/spec/FIREWALL.md).
