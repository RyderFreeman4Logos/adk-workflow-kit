...
4. `workflow-runtime` applies capability and contextual policy before execution. A policy denial is typed and privacy-safe. Compact typed-output envelopes, reason-code registries, deterministic renderers, and the pinned dataset registry live here.
